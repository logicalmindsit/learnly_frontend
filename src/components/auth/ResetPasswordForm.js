...
//     setLoading(true);
//     try {
//       // Backend expects 'newPassword' field
//       const payload = { ...userIdentifier, newPassword };
//       onPasswordReset(payload); // Pass to parent (ForgotPasswordPage)
//     } catch (err) {
...
//         Create a new password for {userIdentifier.email || userIdentifier.mobile}.
//       </Typography>
//       <TextField
//         margin="normal"
//         required
